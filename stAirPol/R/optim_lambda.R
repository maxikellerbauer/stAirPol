...
#'
#' @return numerical value of the esitimated trafficvolumne
#' @export
...
#' Optimize a lambda parameter for the trafficvolume
#'
...
#'
#' @return the lambda which maximises the correlation between the the measured
