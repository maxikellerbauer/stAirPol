#' fit_sp_model
#'
#' Fitting a spatio-temporal baysian model
#'
#' @param data Modelling data.frame which contains information about the
#' covariables and the target variable
#' @param knots_method Only used if the model choise is GPP" or "truncatedGPP",
...
#' @param knots_count Number how much knots should be used, note: if
#' knots_method = 'grid', the knots_count will represent the the square root
#' of the real knot count. there the knots_count spezifies the
#' knots_count x knots_count grid.
