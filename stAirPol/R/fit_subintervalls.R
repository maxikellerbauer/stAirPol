...
#' @param unit unit for splitting the dataset, see \link{lubridate::floor_date}
...
#' @param retry_count How much retrys should be tryed, if some strange behavior
...
#' @param retry_reason_mean retry on a posteriori Mean above that value,
#' default is 500
